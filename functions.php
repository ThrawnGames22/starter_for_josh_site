...
function load_my_scripts() {
  ...
  wp_enqueue_script( 'lottie-interactive','https://unpkg.com/@lottiefiles/lottie-interactivity@latest/dist/lottie-interactivity.min.js', array(), false, true);
  wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/script1.js', array(), false, true);
  ...
  wp_enqueue_script( 'gsap-js-custom', get_stylesheet_directory_uri() . '/script.js', array(), false, true );
